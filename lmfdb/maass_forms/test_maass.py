...
class MaassTest(LmfdbTest):
    ...
    def test_search_N_101(self):
        L = self.tc.get(
            "/ModularForm/GL2/Q/Maass/?hst=List&level=101&search_type=List")
    ...
    def test_search_R_40_50(self):
        L = self.tc.get(
            "/ModularForm/GL2/Q/Maass/?spectral_parameter=40-50&search_type=List")
    ...
    def test_search_R_1234(self):
        L = self.tc.get(
            "/ModularForm/GL2/Q/Maass/?hst=List&spectral_parameter=12.34&search_type=List")
    ...
    def test_underlying_data(self):
        data = self.tc.get(
            "/ModularForm/GL2/Q/Maass/data/54119c4cacf7560af58dd8ba").get_data(as_text=True)
