...
def gg_postprocess(res, info, query):
    ...
    others = list(db.gps_transitive.search(
        {"label": {"$in": others}}, ["label", "order", "gapid", "pretty"]))
...
class GalSearchArray(SearchArray):
    ...
    sorts = [
        ("", "degree", [
            "n", "t"]), ("gp", "order", [
                "order", "gapid", "n", "t"]), ("nilpotency", "nilpotency class", [
                    "nilpotency", "n", "t"]), ("num_conj_classes", "num. conjugacy classes", [
                        "num_conj_classes", "order", "gapid", "n", "t"])]
    jump_example = "8T14"
