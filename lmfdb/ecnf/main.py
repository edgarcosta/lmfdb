...
def index():
    ...
    info['fields'].append(
        [
            'By <a href="{}">real quadratic field</a>'.format(
                url_for(
                    '.statistics_by_signature', d=2, r=2)), ((nf, [
                        url_for(
                            '.show_ecnf1', nf=nf), field_pretty(nf)]) for nf in rqfs)])

    # Imaginary quadratics (sample)
    iqfs = [
        '2.0.{}.1'.format(d) for d in [
            4,
            8,
            3,
            7,
    ...
    info['fields'].append(
        [
            'By <a href="{}">imaginary quadratic field</a>'.format(
                url_for(
                    '.statistics_by_signature', d=2, r=0)), ((nf, [
                        url_for(
                            '.show_ecnf1', nf=nf), field_pretty(nf)]) for nf in iqfs)])
    ...
    info['fields'].append(['By <a href="{}">cubic field</a>'.format(url_for('.statistics_by_degree', d=3)),
                           ((nf, [url_for('.show_ecnf1', nf=nf), field_pretty(nf)]) for nf in cubics)])
    ...
    info['fields'].append(
        [
            'By <a href="{}">totally real quartic field</a>'.format(
                url_for(
                    '.statistics_by_degree', d=4)), ((nf, [
                        url_for(
                            '.show_ecnf1', nf=nf), field_pretty(nf)]) for nf in quartics)])
    ...
    info['fields'].append(
        [
            'By <a href="{}">totally real quintic field</a>'.format(
                url_for(
                    '.statistics_by_degree', d=5)), ((nf, [
                        url_for(
                            '.show_ecnf1', nf=nf), field_pretty(nf)]) for nf in quintics)])
    ...
    info['fields'].append(
        [
            'By <a href="{}">totally real sextic field</a>'.format(
                url_for(
                    '.statistics_by_degree', d=6)), ((nf, [
                        url_for(
                            '.show_ecnf1', nf=nf), field_pretty(nf)]) for nf in sextics)])
...
def download_search(info):
    ...
    s = com1 + "\n"
    s += com + \
        ' Elliptic curves downloaded from the LMFDB downloaded on %s.\n' % (mydate)
    s += com + ' Below is a list called data. Each entry has the form:\n'
    s += com + \
        '   [[field_poly],[Weierstrass Coefficients, constant first in increasing degree]]\n'
    s += '\n' + com2
    s += '\n'
    ...
    s += '\\\n'
    nf_dict = {}
    for f in db.ec_nfcurves.search(
        ast.literal_eval(
            info["query"]), [
            'field_label', 'ainvs']):
...
def elliptic_curve_search(info, query):
    ...
    parse_primes(
        ...
        mode=info.get('nonmax_quantifier'),
        radical='nonmax_rad')
...
class ECNFSearchArray(SearchArray):
    ...
    sorts = [
        ("", "field", [
            'degree', 'signature', 'abs_disc', 'field_label', 'conductor_norm', 'conductor_label', 'iso_nlabel', 'number']), ("conductor_norm", "conductor norm", [
                'conductor_norm', 'conductor_label', 'degree', 'signature', 'abs_disc', 'field_label', 'iso_nlabel', 'number']), ("root_analytic_conductor", "root analytic conductor", [
                    'root_analytic_conductor', 'degree', 'signature', 'abs_disc', 'field_label', 'conductor_norm', 'conductor_label', 'iso_nlabel', 'number']), ("rank", "rank", [
                        'rank', 'degree', 'signature', 'abs_disc', 'field_label', 'conductor_norm', 'conductor_label', 'iso_nlabel', 'number']), ("torsion", "torsion", [
                            'torsion_order', 'degree', 'signature', 'abs_disc', 'field_label', 'conductor_norm', 'conductor_label', 'iso_nlabel', 'number']), ("cm", "CM discriminant", [
                                "cm", 'degree', 'signature', 'abs_disc', 'field_label', 'conductor_norm', 'conductor_label', 'iso_nlabel', 'number']), ("reg", "regulator", [
                                    "reg", 'degree', 'signature', 'abs_disc', 'field_label', 'conductor_norm', 'conductor_label', 'iso_nlabel', 'number']), ("sha", "analytic &#1064;", [
                                        "sha", 'degree', 'signature', 'abs_disc', 'field_label', 'conductor_norm', 'conductor_label', 'iso_nlabel', 'number']), ("class_size", "isogeny class size", [
                                            "class_size", 'degree', 'signature', 'abs_disc', 'field_label', 'conductor_norm', 'conductor_label', 'iso_nlabel', 'number']), ("class_deg", "isogeny class degree", [
                                                "class_deg", 'degree', 'signature', 'abs_disc', 'field_label', 'conductor_norm', 'conductor_label', 'iso_nlabel', 'number'])]
    ...
    def __init__(self):
        ...
        tor_opts = ([("", ""), ("[]", "trivial")] + [disp_tor(tuple(t))
                                                     for t in ECNF_stats().torsion_counts if t])
