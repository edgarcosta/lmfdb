...
class HomePageTest(LmfdbTest):
    ...
    def test_box1(self):
        ...
        self.check(
            homepage,
            "/EllipticCurve/Q/?conductor=1-99",
            '[1, 0, 1, -11, 12]')
        self.check(
            homepage,
            "/ModularForm/GL2/Q/Maass/",
            '/BrowseGraph/1/15/0/15/')
        # the interesting numbers are filled in dynamically
        self.check(homepage, "/zeros", 'The zeros are accurate')
        self.check(
            homepage,
            "/NumberField/?degree=2",
            '"/NumberField/2.0.8.1">2.0.8.1')
    ...
    def test_box3(self):
        ...
        self.check(
            homepage,
            "/NumberField/",
            'x^7 - x^6 - 3 x^5 + x^4 + 4 x^3 - x^2 - x + 1')
    ...
    def test_box4(self):
        ...
        self.check(
            homepage,
            "/L/degree4/MaassForm/",
            'data on L-functions associated to Maass cusp forms for GSp(4) of level 1')
        self.check(homepage, "/EllipticCurve/Q/102/c/",
                   r'1 &amp; 2 &amp; 4 &amp; 4 &amp; 8 &amp; 8')
