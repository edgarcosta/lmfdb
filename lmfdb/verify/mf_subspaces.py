...
class mf_subspaces(SubspacesChecker):
    ...
    def check_sub_label(self):
        ...
        return self.check_string_concatenation(
            'sub_label', ['sub_level', 'weight', 'sub_char_orbit_label'])
    ...
    def check_sub_char_orbit_label(self):
        ...
        """
        # TIME about 20s
        return self.check_letter_code(
            'sub_char_orbit_index',
            'sub_char_orbit_label')
    ...
    def check_conrey_indexes(self):
        ...
        return self.check_crosstable(
            'char_dir_orbits', 'conrey_indexes', [
                'level', 'char_orbit_index'], 'galois_orbit', [
                'modulus', 'orbit_index'])
    ...
    def check_sub_conrey_indexes(self):
        ...
        # TIME about 10s
        return self.check_crosstable(
            'char_dir_orbits', 'sub_conrey_indexes', [
                'sub_level', 'sub_char_orbit_index'], 'galois_orbit', [
                'modulus', 'orbit_index'])
