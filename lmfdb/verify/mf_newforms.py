...
class mf_newforms(MfChecker):
    ...
    def check_field_poly_consequences(self):
        ...
        """
        return self.check_non_null(['is_polredabs',
    ...
    def check_traces_length(self):
        ...
        return (
            self.check_non_null(
                ['traces']) + self.check_array_len_gte_constant(
                'traces',
                1000,
                constraint={
                    'level': {
                        '$lte': 1000}}) + self.check_array_len_gte_constant(
                'traces',
                2000,
                constraint={
                    'level': {
                        '$gt': 1000,
                        '$lte': 4000}}) + self.check_array_len_gte_constant(
                'traces',
                3000,
                constraint={
                    'level': {
    ...
    def check_number_field(self):
        ...
        return (self.check_crosstable_count('nf_fields',
                                            1,
                                            'nf_label',
                                            'label',
                                            constraint=nfyes) + self.check_crosstable('nf_fields',
                                                                                      'field_poly',
                                                                                      'nf_label',
                                                                                      'coeffs',
                                                                                      'label',
                                                                                      constraint=nfyes) + self.check_crosstable('nf_fields',
                                                                                                                                ...
                                                                                                                                'r2',
                                                                                                                                'label',
                                                                                                                                constraint=selfdual) + self.check_crosstable_dotprod('nf_fields',
                                                                                                                                                                                     'field_disc',
                                                                                                                                                                                     'nf_label',
                                                                                                                                                                                     ['disc_sign',
                                                                                                                                                                                      'disc_abs'],
    ...
    def check_self_twist_type(self):
        ...
        """
        # TIME about 6s
        return (self.check_non_null(['is_cm',
                                     'is_rm']) + self.check_iff({'self_twist_type': 0},
                                                                {'is_cm': False,
                                                                 'is_rm': False}) + self.check_iff({'self_twist_type': 1},
                                                                                                   {'is_cm': True,
                                                                                                    'is_rm': False}) + self.check_iff({'self_twist_type': 2},
                                                                                                                                      {'is_cm': False,
                                                                                                                                       'is_rm': True}) + self.check_iff({'self_twist_type': 3},
                                                                                                                                                                        {'is_cm': True,
                                                                                                                                                                         'is_rm': True}))
    ...
    def check_cmrm_discs(self):
        ...
        """
        # TIME about 10s
        return (self.check_array_len_eq_constant('rm_discs',
                                                 0,
                                                 {'is_rm': False}) + self.check_array_len_eq_constant('rm_discs',
                                                                                                      1,
                                                                                                      {'is_rm': True}) + self.check_array_len_eq_constant('cm_discs',
                                                                                                                                                          0,
                                                                                                                                                          {'is_cm': False}) + self.check_array_len_eq_constant('cm_discs',
                                                                                                                                                                                                               1,
                                                                                                                                                                                                               {'self_twist_type': 1}) + self.check_array_len_eq_constant('cm_discs',
                                                                                                                                                                                                                                                                          2,
                                                                                                                                                                                                                                                                          {'self_twist_type': 3}))
    ...
    def check_fricke_eigenval(self):
        ...
        # TIME about 3s
        return self._run_query(
            SQL('fricke_eigenval != prod2(atkin_lehner_eigenvals)'), {
                'fricke_eigenval': {
                    '$exists': True}})
    ...
    def check_sato_tate_value(self):
        ...
        return (
            self._run_query(
                SQL("sato_tate_group != (weight-1) || {0} || char_order").format(
                    Literal(".2.3.c")), constraint={
                    'is_cm': False, 'weight': {
                        '$gt': 1}}) + self._run_query(
                SQL("sato_tate_group != (weight-1) || {0} || char_order").format(
                    Literal(".2.1.d")), constraint={
                    'is_cm': True, 'weight': {
                        '$gt': 1}}))
    ...
    def check_projective_image(self):
        ...
        return (
            self.check_eq(
                'projective_image_type', 'projective_image', {
                    'projective_image_type': {
                        '$ne': 'Dn'}}) + self.check_string_startswith(
                    'projective_image', 'D', {
    ...
    def check_projective_field(self):
        ...
        # TIME > 240s
        return (
            self.check_crosstable_count(
                'nf_fields',
                1,
                'projective_field_label',
                'label',
                constraint={
                    'projective_field_label': {
                        '$exists': True}}) + self.check_crosstable(
                    'nf_fields',
                    'projective_field',
                    'projective_field_label',
                    'coeffs',
    ...
    def check_artin_degree(self):
        ...
        """
        return self.check_divisible(
            'artin_degree',
            SQL("array_length(artin_field, 1) - 1"),
            constraint={
                'artin_field': {
                    '$exists': True}})
    ...
    def check_trivial_character_cols(self):
        ...
        # TIME about 1s
        yes = {'$exists': True}
        return self.check_iff({'atkin_lehner_eigenvals': yes,
                               'atkin_lehner_string': yes,
                               'fricke_eigenval': yes},
                              {'char_orbit_index': 1})
    ...
    def check_inner_twists(self):
        ...
        """
        return (self._run_query(SQL("inner_twist_count != (SELECT SUM(s) FROM UNNEST((inner_twists[1:array_length(inner_twists,1)][2:2])) s)"), constraint={
                'inner_twist_count': {'$gt': 0}}) + self.check_values({'inner_twists': {'$exists': True}, 'inner_twist_count': {'$gt': 0}}, {'field_poly': {'$exists': True}}))
    ...
    def check_has_non_self_twist(self):
        ...
        return (self.check_iff({'inner_twist_count': -1},
                               {'has_non_self_twist': -1}) + self.check_values({'inner_twist_count': 1},
                                                                               {'has_non_self_twist': 0,
                                                                                'self_twist_type': 0}) + self.check_values({'inner_twist_count': 2},
                                                                                                                           {'has_non_self_twist': 0,
                                                                                                                            'self_twist_type': 1}) + self.check_values({'inner_twist_count': 2},
                                                                                                                                                                       {'has_non_self_twist': 0,
                                                                                                                                                                        'self_twist_type': 2}) + self.check_values({'inner_twist_count': 4},
                                                                                                                                                                                                                   {'has_non_self_twist': 0,
                                                                                                                                                                                                                    'self_twist_type': 3}) + self.check_values({'inner_twist_count': {'$gt': 1}},
                                                                                                                                                                                                                                                               {'has_non_self_twist': 1,
                                                                                                                                                                                                                                                                'self_twist_type': 0}) + self.check_values({'inner_twist_count': {'$gt': 2}},
                                                                                                                                                                                                                                                                                                           {'has_non_self_twist': 1,
                                                                                                                                                                                                                                                                                                            'self_twist_type': 1}) + self.check_values({'inner_twist_count': {'$gt': 2}},
                                                                                                                                                                                                                                                                                                                                                       {'has_non_self_twist': 1,
                                                                                                                                                                                                                                                                                                                                                        'self_twist_type': 2}) + self.check_values({'inner_twist_count': {'$gt': 4}},
                                                                                                                                                                                                                                                                                                                                                                                                   {'has_non_self_twist': 1,
                                                                                                                                                                                                                                                                                                                                                                                                    'self_twist_type': 3}))
    ...
    def check_field_disc_factorization(self):
        ...
        # TIME about 3s
        return self._run_query(
            SQL('field_disc != prod_factorization(field_disc_factorization)'), {
                'field_disc': {
                    '$exists': True}})
    ...
    def check_hecke_ring_index_factorization(self):
        ...
        # TIME about 2s
        return self._run_query(
            SQL('hecke_ring_index != prod_factorization(hecke_ring_index_factorization)'), {
    ...
    def check_analytic_rank_set(self):
        ...
        """
        return accumulate_failures(self.check_non_null(['analytic_rank'], self._box_query(
            box)) for box in db.mf_boxes.search({'lfunctions': True}))
    ...
    @fast(constraint={'projective_field': {'$exists': True}},
          projection=['projective_field',
                      'projective_image',
                      'projective_image_type'])
    ...
    def check_self_twist_disc(self, rec, verbose=False):
        ...
        """
        return self._test_equality(set(rec['self_twist_discs']), set(
    ...
    @fast(constraint={'nf_label': None,
                      'field_poly': {'$exists': True}},
          projection=['field_poly',
                      'is_self_dual'])
            ...
            if url.startswith('/EllipticCurve/Q/'):
                ...
                if rec['dim'] == 1:
                    ...
                    if rec['level'] != int(name.split()[-1].split('.')[0]):
                        ...
                        return False
        if (rec['weight'] == 2 and rec['char_orbit_index'] == 1 and rec['dim'] ==
                1 and not any(url.startswith('/EllipticCurve/Q/') for name, url in names)):
            if verbose:
    ...
    @slow(ratio=1,
          constraint={'artin_image': {'$exists': True}},
          projection=['projective_image',
                      'artin_image',
                      'artin_degree'])
    ...
    def check_embeddings_count(self):
        ...
        return accumulate_failures(
            self.check_crosstable_count(
                ...
                'dim',
                'hecke_orbit_code',
                constraint=self._box_query(box)) for box in db.mf_boxes.search(
                {
                    'embeddings': True}))
