...
class CmfTest(LmfdbTest):
    ...
    def test_expression_divides(self):
        ...
        self.check_args(
            '/ModularForm/GL2/Q/holomorphic/?level_type=divides&level=1000&search_type=List',
            '40.2.k.a')
    ...
    def test_badp(self):
        data = self.tc.get(
            "/ModularForm/GL2/Q/holomorphic/?level_primes=7&count=100&search_type=List").get_data(as_text=True)
    ...
    def test_level_bread(self):
        page = self.tc.get(
            '/ModularForm/GL2/Q/holomorphic/1124/',
            ...
            [
                ...
                '55.3.d', '55.3.d'], [
                    '55.3.54', '55.3.d'], [
                        '20.5', '20.5'], [
                            'yes', '23.1.b.a'], [
                                'yes&weight=2', '11.2.a.a'], [
                                    'yes&weight=-2', 'There are no newforms specified by the query']]:
            page = self.tc.get(
                "/ModularForm/GL2/Q/holomorphic/?jump=%s" %
    ...
    def test_failure(self):
        ...
        page = self.tc.get(
            '/ModularForm/GL2/Q/holomorphic/?level=1000&weight=100-&search_type=List',
            follow_redirects=True)
    ...
    def test_satake(self):
        ...
        for url in [
            '/ModularForm/GL2/Q/holomorphic/7/3/b/a/?&format=satake_angle',
                '/ModularForm/GL2/Q/holomorphic/7/3/b/a/6/1/']:
            page = self.tc.get(url)
        ...
        for url in [
            '/ModularForm/GL2/Q/holomorphic/5/9/c/a/?n=2-10&m=1-6&prec=6&format=satake',
        ...
        for url in [
            '/ModularForm/GL2/Q/holomorphic/31/2/c/a/?m=1-4&n=2-10&prec=6&format=satake',
        ...
        for url in [
            '/ModularForm/GL2/Q/holomorphic/31/2/c/a/?m=1-4&n=2-10&prec=6&format=satake_angle',
            '/ModularForm/GL2/Q/holomorphic/31/2/c/a/5/1/',
            '/ModularForm/GL2/Q/holomorphic/31/2/c/a/25/1/',
        ]:
            page = self.tc.get(url)
        ...
        # test large floats
        for url in [
            '/ModularForm/GL2/Q/holomorphic/1/36/a/a/?m=1-3&n=695-696&prec=6&format=embed',
        ...
        for url in [
            '/ModularForm/GL2/Q/holomorphic/1/36/a/a/?m=1-3&n=695-696&prec=6&format=analytic_embed',
                '/ModularForm/GL2/Q/holomorphic/1/36/a/a/1/1/']:
            page = self.tc.get(url)
