...
nf_columns = SearchColumns(
    [
        ProcessedCol(
            ...
            "nf.label",
            "Label",
            lambda label: '<a href="%s">%s</a>' % (url_for_label(label),
                                                   nf_label_pretty(label)),
            default=True),
        SearchCol(
            "poly",
        ...
        MathCol(
            ...
            "nf.ramified_primes",
            "Ram. prime count",
            short_title="ramified prime count"),
        MathCol(
            "rd",
...
def number_field_search(info, query):
    ...
    parse_primes(
        ...
        query,
        'inessentialp',
        name='Inessential primes',
        qfield='inessentialp',
        mode=info.get('inessential_quantifier'))
