...
cycloinfo = {
    ...
    '4.0.256.1': 8,
    '6.0.19683.1': 9,
    '10.0.2357947691.1': 11,
    '4.0.144.1': 12,
    '12.0.1792160394037.1': 13,
    '8.0.1265625.1': 15,
    '8.0.16777216.1': 16,
    '16.0.2862423051509815793.1': 17,
    '18.0.5480386857784802185939.1': 19,
    '8.0.4000000.1': 20,
    '12.0.205924456521.1': 21,
    '22.0.39471584120695485887249589623.1': 23,
    '8.0.5308416.1': 24,
    '20.0.2910383045673370361328125.1': 25,
    '18.0.2954312706550833698643.1': 27,
    '12.0.1157018619904.1': 28,
    '28.0.3053134545970524535745336759489912159909.1': 29,
    '30.0.17761887753093897979823770061456102763834271.1': 31,
    '16.0.18446744073709551616.1': 32,
    '20.0.328307557444402776721569.1': 33,
...
rcycloinfo = {
    ...
    '4.4.2048.1': 16,
    '8.8.410338673.1': 17,
    '9.9.16983563041.1': 19,
    '4.4.2000.1': 20,
    '6.6.453789.1': 21,
    '11.11.41426511213649.1': 23,
    '4.4.2304.1': 24,
    '10.10.762939453125.1': 25,
    '9.9.31381059609.1': 27,
    '6.6.1075648.1': 28,
    '14.14.10260628712958602189.1': 29,
    '15.15.756943935220796320321.1': 31,
    '8.8.2147483648.1': 32,
    '10.10.572981288913.1': 33,
    '12.12.551709470703125.1': 35,
    '6.6.1259712.1': 36,
    '18.18.456487940826035155404146917.1': 37,
    '12.12.1306484927252973.1': 39,
    '8.8.1024000000.1': 40,
    '20.20.4394336169668803158610484050361.1': 41,
    '21.21.467056167777397914441056671494001.1': 43,
    '10.10.2414538435584.1': 44,
    ...
    if d == '4':
        ...
        if len(subs) == 3:  # only for V_4 fields
            ...
            if not any(z._data is None for z in subs):
                ...
                labels = sorted(
                    [[ZZ(z[2]).squarefree_part(), - int(z[1])] for z in labels])
                # put in +/- sign
...
class WebNumberField:
    ...
    def cnf(self):
        ...
        ltx = r'%s\frac{%s%s %s \cdot %s}{%s\sqrt{%s}}' % (
            approx1, r1term, r2term, str(reg), h, w, disc)
        ltx += r'\approx %s$' % (2**r1 * (2 * RR(pi))
                                 ** r2 * reg * h / (w * sqrt(RR(disc))))
        return ltx
    ...
    def disc_factored_latex(self):
        ...
        if D < 0:
            s = r'-\,'
        return s + \
            factor_base_factorization_latex(factor_base_factor(D, self.ramified_primes()))
    ...
    def make_code_snippets(self):
        ...
        self.code['show'] = {'sage': '', 'pari': '',
                             'magma': ''}  # use default show names
