...
class AVTest(LmfdbTest):
    ...
    def test_is_simple(self):
        ...
        self.check_args(
            ...
            'not <a title="Simple abelian variety [av.simple]" knowl="av.simple" kwargs="">simple</a>')
    ...
    def test_download_curves(self):
        ...
        page = self.tc.get(
            'Variety/Abelian/Fq/3.17.d_b_act',
            follow_redirects=True)
        assert 'Curves to text' not in page.get_data(as_text=True)

        page = self.tc.get(
            'Variety/Abelian/Fq/download_curves/3.17.d_b_act',
            follow_redirects=True)
        assert 'No curves for abelian variety isogeny class 3.17.d_b_act' in page.get_data(
            as_text=True)
